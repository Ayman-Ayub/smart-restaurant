...
const UpdateFreshCategory = () => {
  ...
  const updatecategory = async (uid) => {
    ...
    if (  imageAsset !== "" && title === "") {
     ...
     const updatedocument = doc(firestore, "freshfoodCategory", uid);
...
export default UpdateFreshCategory;
